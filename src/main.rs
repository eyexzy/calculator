...
use pest::Parser;
use pest::pratt_parser::{Assoc::*, PrattParser, Op as PrattOp};
...
lazy_static! {
    static ref PRATT_PARSER: PrattParser<Rule> = {
        ...
        PrattParser::new()
            .op(PrattOp::infix(add, Left) | PrattOp::infix(subtract, Left))
            .op(PrattOp::infix(multiply, Left) | PrattOp::infix(divide, Left))
            .op(PrattOp::prefix(unary_minus))
    };
}
